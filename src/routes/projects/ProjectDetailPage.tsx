    ...
    <>
      <article className="projects-detail">
        ...
        <header className="projects-detail__header">
          ...
          <section
            className="projects-detail__section projects-detail__section--intro"
            aria-label="Summary and description"
          >
      ...
      <footer className="projects-list__footer">
        <p>© {new Date().getFullYear()} Reinaldo Assis</p>
        <p>Brazil</p>
      </footer>
    </>
  )
